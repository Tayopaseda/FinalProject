...
public class TicketServiceIntegrationTests {
	...
	private Ticket ticket_3 = new Ticket(3L, "Aadil", "FebCNative", "terraform", "Vinesh", "low", "jenkins", "time","sdbdjbdjbdbd","solution", true);
	private Ticket ticket_4 = new Ticket(4L, "Haydon", "FebCNative", "GCP", "reece", "low", "Security rules", "time","sdbdjbdjbdbd","", false);
	
	
	@Test
	public void testCreate() {
		Assertions.assertThat(this.service.create(new Ticket("Haydon", "FebCNative", "GCP", "reece", "low", "Security rules","time","sdbdjbdjbdbd",""))).isEqualTo(ticket_4);
	...
	void testToggleCompleted() {
		Assertions.assertThat(this.service.toggleCompleted(1L)).isEqualTo(new Ticket(1L, "Shamsi", "FebCNative", "terraform", "nathan", "low", "Terraform init","time" ,"React issue","", true));
	}
