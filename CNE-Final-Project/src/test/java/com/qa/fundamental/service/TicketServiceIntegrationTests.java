...
public class TicketServiceIntegrationTests {
	...
	public void testCreate() {
		Assertions.assertThat(this.service.create(new Ticket("Haydon", "FebCNative", "GCP", "reece", "Security rules","time","sdbdjbdjbdbd","solution"))).isEqualTo(ticket_4);
	...
	void testToggleCompleted() {
		Assertions.assertThat(this.service.toggleCompleted(1L)).isEqualTo(new Ticket(1L, "Shamsi", "FebCNative", "terraform", "nathan", "Terraform init","time" ,"React issue","solution", true));
	}
