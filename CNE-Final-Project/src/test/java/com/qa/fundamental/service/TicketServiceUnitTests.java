...
public class TicketServiceUnitTests {
	...
	private Ticket ticket_12 = new Ticket(1L, "Shamsi", "FebCNative", "terraform", "nathan", "Terraform init","time","React issue","solution", true);
	...
	@Test
	void testCreate() {
		Mockito.when(this.repo.save(new Ticket("Shamsi", "FebCNative", "terraform", "nathan", "Terraform init", "time","sdbdjbdjbdbd","solution"))).thenReturn(ticket_1);
		Assertions.assertThat(this.service.create(new Ticket("Shamsi", "FebCNative", "terraform", "nathan", "Terraform init", "time","sdbdjbdjbdbd","solution"))).isEqualTo(ticket_1);
		Mockito.verify(this.repo, Mockito.times(1)).save(new Ticket("Shamsi", "FebCNative", "terraform", "nathan", "Terraform init", "time","sdbdjbdjbdbd","solution"));
	}
