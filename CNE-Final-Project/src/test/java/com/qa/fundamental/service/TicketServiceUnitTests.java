...
public class TicketServiceUnitTests {
	...
	private Ticket ticket_1 = new Ticket(1L, "Shamsi", "FebCNative", "terraform", "nathan", "low", "Terraform init","time","React issue","", false);
	private Ticket ticket_1_updated = new Ticket(1L, "Shamsi", "FebCNative", "terraform", "terry", "low", "Terraform init", "time","sdbdjbdjbdbd","", false);
	private Ticket ticket_12 = new Ticket(1L, "Shamsi", "FebCNative", "terraform", "nathan", "low", "Terraform init","time","React issue","", true);
	private Ticket ticket_2 = new Ticket(2L, "trainee2", "cnejan", "frontend", "Reece", "low", "react","time" ,"React issue","", false);
	private Ticket ticket_3 = new Ticket(3L, "Aadil", "FebCNative", "terraform", "Vinesh", "low", "jenkins", "time","sdbdjbdjbdbd","", true);
	private Ticket ticket_4 = new Ticket(4L, "Haydon", "FebCNative", "GCP", "reece", "low", "Security rules", "time","sdbdjbdjbdbd","", false);
	
	@Test
	void testCreate() {
		Mockito.when(this.repo.save(new Ticket("Shamsi", "FebCNative", "terraform", "nathan", "low", "Terraform init", "time","sdbdjbdjbdbd",""))).thenReturn(ticket_1);
		Assertions.assertThat(this.service.create(new Ticket("Shamsi", "FebCNative", "terraform", "nathan", "low", "Terraform init", "time","sdbdjbdjbdbd",""))).isEqualTo(ticket_1);
		Mockito.verify(this.repo, Mockito.times(1)).save(new Ticket("Shamsi", "FebCNative", "terraform", "nathan", "low", "Terraform init", "time","sdbdjbdjbdbd",""));
	}
