            ...
            <Modal.Body>
              <Form onSubmit={completeTicket}>
                <Form.Group>
                  ...
                  <Form.Control readOnly value={traineeName} />
                </Form.Group>

                <Form.Group>
                  <Form.Label>Cohort</Form.Label>
                  <Form.Control readOnly value={cohort}></Form.Control>
                </Form.Group>

                <Form.Group>
                  <Form.Label>Topics</Form.Label>
                  <Form.Control readOnly value={topic}></Form.Control>
                </Form.Group>

                <Form.Group>
                  <Form.Label>Trainer</Form.Label>
                  <Form.Control readOnly value={trainer}></Form.Control>
                </Form.Group>
                <Form.Group>
                  <Form.Label>Urgency</Form.Label>
                  <Form.Control readOnly value={urgency}></Form.Control>
                </Form.Group>
              ...
              <Button type="submit" variant="success" size="lg" block disabled>
                Complete Ticket
              </Button>
            </Modal.Body>
          </Modal>
